...
namespace CST407_BlowFish
{
    public class BlowFish
    {
        ...
        public static string[] S0 = new string[256]
        {
        ...
        public static string[] S1 = new string[256]
        {
        ...
        public static string[] S2 = new string[256]
        {
        ...
        public static string[] S3 = new string[256]
        {
        ...
        private string BlowFishEncrypt(string plainTextHex)
        {
            ...
            for (var j = 0; j < plainTextHex.Length; j += 16)
            {
                ...
                for (var i = 0; i < 16; i++)
                {
                    //newPlainTextHex = Round(i, newPlainTextHex.Substring(j, 16));
        ...
        public static string leftInput;
        ...
        public string Decrypt(string cipherTextHex)
        {
            ...
            //var cipherText = ConvertBinaryToString(ConvertHexStringToBinaryString(cipherTextHex));
            return cipherText;
        }
        ...
        private string BlowFishDecrypt(string cipherTextHex)
        {
            ...
            for (var j = 0; j < cipherTextHex.Length; j += 16)
            {
                ...
                for (var i = 17; i > 1; i--)
                {
                    //newCipherTextHex = Round(i, newCipherTextHex.Substring(j, 16));
        ...
        public static string PadKey(string bits)
        {
            if (bits.Length % 32 != 0)
            {
                var sb = new StringBuilder();
        ...
        public static string PadPlainText(string bits)
        {
            if (bits.Length % 64 != 0)
            {
                var sb = new StringBuilder();
        ...
        public static string BinaryAddition(string hex1, string hex2)
        {
        ...
        public static string ConvertBinaryToString(string b)
        {
        ...
        public static string ConvertBinaryStringToHexString(string bits)
        {
            return string.Join("",
